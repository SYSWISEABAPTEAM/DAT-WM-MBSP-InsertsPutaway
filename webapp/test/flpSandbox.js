		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "WM: Mobile Service Pack - Inserts Putaway",
									"targetURL": "#comsyswisewmmbspinsertsputaway-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsyswisewmmbspinsertsputaway-display": {
								"semanticObject": "comsyswisewmmbspinsertsputaway",
								"action": "display",
								"description": "WM: Mobile Service Pack - Inserts Putaway",
								"title": "WM: Mobile Service Pack - Inserts Putaway",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.syswise.wm.mbsp.insertsputaway",
									"url": sap.ui.require.toUrl("com/syswise/wm/mbsp/insertsputaway")
								}
							}
						}
					}
